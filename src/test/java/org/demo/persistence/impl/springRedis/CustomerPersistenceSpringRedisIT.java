...
public class CustomerPersistenceSpringRedisIT extends CustomerPersistenceGenericTest {
	...
	public void testPersistenceService() throws Exception {
		CustomerPersistenceSpringRedis persistence = new CustomerPersistenceSpringRedis();
