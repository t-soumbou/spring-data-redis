...
public class BookOrderPersistenceSpringRedisIT extends BookOrderPersistenceGenericTest {
	...
	public void testPersistenceService() throws Exception {
		BookOrderPersistenceSpringRedis persistence = new BookOrderPersistenceSpringRedis();
