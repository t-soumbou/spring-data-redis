...
public class PublisherPersistenceSpringRedisIT extends PublisherPersistenceGenericTest {
	...
	public void testPersistenceService() throws Exception {
		PublisherPersistenceSpringRedis persistence = new PublisherPersistenceSpringRedis();
