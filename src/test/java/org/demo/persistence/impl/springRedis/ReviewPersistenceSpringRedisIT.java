...
public class ReviewPersistenceSpringRedisIT extends ReviewPersistenceGenericTest {
	...
	public void testPersistenceService() throws Exception {
		ReviewPersistenceSpringRedis persistence = new ReviewPersistenceSpringRedis();
