...
public class EmployeePersistenceSpringRedisIT extends EmployeePersistenceGenericTest {
	...
	public void testPersistenceService() throws Exception {
		EmployeePersistenceSpringRedis persistence = new EmployeePersistenceSpringRedis();
