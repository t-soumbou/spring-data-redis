...
public class SynopsisPersistenceSpringRedisIT extends SynopsisPersistenceGenericTest {
	...
	public void testPersistenceService() throws Exception {
		SynopsisPersistenceSpringRedis persistence = new SynopsisPersistenceSpringRedis();
