...
public class CarPersistenceSpringRedisIT extends CarPersistenceGenericTest {
	...
	public void testPersistenceService() throws Exception {
		CarPersistenceSpringRedis persistence = new CarPersistenceSpringRedis();
		persistence.setRedisTemplate(redisTemplate);
		persistence.setCounterCar(redisAt);
